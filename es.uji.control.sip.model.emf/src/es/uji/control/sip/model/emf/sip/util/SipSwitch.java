...
public class SipSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SipPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SipPackage.ACCREDITATION: {
				Accreditation accreditation = (Accreditation)theEObject;
				T result = caseAccreditation(accreditation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SipPackage.LINKAGE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Accreditation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Accreditation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAccreditation(Accreditation object) {
		return null;
	}
