...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sip</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SipExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.sip"));
				Model root = SipFactory.eINSTANCE.createModel();
